...
import {
  rcp,
  acp
} from 'ember-cli-reduce-computed-macros';

var computedSum = rcp.sum;
var computedMin = rcp.min;
var computedMax = rcp.max;
var computedMap = acp.map;
var computedSort = acp.sort;
var computedSetDiff = acp.setDiff;
var computedMapBy = acp.mapBy;
var computedFilter = acp.filter;
var computedFilterBy = acp.filterBy;
var computedUniq = acp.uniq;
var computedUnion = acp.union;
var computedIntersect = acp.intersect;
...
forEach([['uniq', computedUniq], ['union', computedUnion]], function (tuple) {
  var alias  = tuple[0];
